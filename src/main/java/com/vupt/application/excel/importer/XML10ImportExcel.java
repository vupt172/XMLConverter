...
public class XML10ImportExcel {
    ...
    public XML10 readExcel() throws IOException {
        ...
        XML10 xml10 = getValueFromRow(currentRow);
        return xml10;
    }

    private XML10 getValueFromRow(Row currentRow) {
        try {
            ...
            throw new AppException("Đã có lỗi xảy ra khi truy xuất dữ liệu từ Excel bảng XML10 hàng thứ " + currentRow.getRowNum() + "\n" + e.toString() + ": " + e.getMessage(), e.getStackTrace());
        }
    }
}
